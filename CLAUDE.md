...
- `_ensure_base_csv` / `_assert_escrita_fora_da_fonte` — ao selecionar empresa, regenera `Base.csv` no trabalho a partir do BI da fonte se ausente ou desatualizado; aborta se o destino estiver sob a fonte ou se fonte == trabalho.
